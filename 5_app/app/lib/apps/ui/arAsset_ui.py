...
"/*padding: 9px;")
        ...
        self.imgAsset = QPushButton(self.wgHoverAssets)
        self.imgAsset.setObjectName(u"imgAsset")
        self.imgAsset.setEnabled(False)
        sizePolicy3 = QSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding)
        sizePolicy3.setHorizontalStretch(0)
        sizePolicy3.setVerticalStretch(0)
        sizePolicy3.setHeightForWidth(self.imgAsset.sizePolicy().hasHeightForWidth())
        self.imgAsset.setSizePolicy(sizePolicy3)
        self.imgAsset.setMaximumSize(QSize(80, 16777215))
        self.imgAsset.setBaseSize(QSize(0, 0))
        self.imgAsset.setStyleSheet(u"QPushButton:hover {transparent}")
...
"padding-left: 10px;}")
        ...
        self.pageBlueprints.setMaximumSize(QSize(16777215, 30))
...
"padding-left: 10px;}")
        icon = QIcon()
        self.iconArrowBlueprint.setIcon(icon)
        self.iconArrowBlueprint.setIconSize(QSize(12, 12))
...
"")
        icon1 = QIcon()
        self.btnBlueprintName.setIcon(icon1)
